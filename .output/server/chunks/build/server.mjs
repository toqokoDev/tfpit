import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, ref, inject, h, Suspense, toRef, isRef, hasInjectionContext, provide, shallowReactive, Fragment, getCurrentInstance, createElementBlock, shallowRef, cloneVNode, defineAsyncComponent, computed, unref, useSSRContext, createApp, reactive, mergeProps, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, effectScope, isReadonly, isShallow, isReactive, toRaw, nextTick, getCurrentScope } from 'vue';
import { h as createError$1, k as hasProtocol, l as isScriptProtocol, m as joinURL, w as withQuery, n as sanitizeStatusCode, o as getContext, $ as $fetch, p as createHooks, q as executeAsync, r as getHeader, v as toRouteMatcher, x as createRouter$1, y as defu, z as setCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-4FQUW5ol.mjs')
  },
  {
    name: "about-help",
    path: "/about/help",
    component: () => import('./help-BN7f3tYQ.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./login-CsAIOz8y.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./index-BCCOSqXv.mjs')
  },
  {
    name: "about-rules",
    path: "/about/rules",
    component: () => import('./rules-DaMO-gCd.mjs')
  },
  {
    name: "offer",
    path: "/offer",
    component: () => import('./index-YD-IHzmu.mjs')
  },
  {
    name: "auth-confirm",
    path: "/auth/confirm",
    component: () => import('./confirm-CDHMx1pT.mjs')
  },
  {
    name: "auth-register",
    path: "/auth/register",
    meta: __nuxt_page_meta || {},
    component: () => import('./register-lLT2SI_0.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    meta: { "middleware": "auth" },
    component: () => import('./index-CgSZGWKv.mjs')
  },
  {
    name: "about-contacts",
    path: "/about/contacts",
    component: () => import('./contacts-CUn3TklP.mjs')
  },
  {
    name: "portfolio-id",
    path: "/portfolio/:id()",
    component: () => import('./_id_-BIlaCAW8.mjs')
  },
  {
    name: "profile-portfolio",
    path: "/profile/portfolio",
    meta: { "middleware": "auth" },
    component: () => import('./portfolio-DBpQHCGv.mjs')
  }
];
...
const layouts = {
  blank: defineAsyncComponent(() => import('./blank-Dd2qM3zW.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-BP3jKNcY.mjs').then((m) => m.default || m))
};
...
const __nuxt_component_3 = Object.assign(_sfc_main$3, { __name: "UiSonner" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      ...
      bodyAttrs: {
        class: "color-white theme-system"
      }
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ui_sonner = __nuxt_component_3;
      _push(ssrRenderComponent(_component_Body, mergeProps({ class: "overscroll-none antialiased bg-background text-foreground" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="h-screen"${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_component_ui_sonner, { position: "bottom-right" }, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "h-screen" }, [
                ...
                createVNode(_component_ui_sonner, { position: "bottom-right" })
              ])
            ];
          }
        }),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-KaiOWGZs.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DIRScPwJ.mjs'));
...
export { __nuxt_component_5 as _, useSupabaseUser as a, useRoute as b, cn as c, useRouter as d, entry_default as default, defineNuxtRouteMiddleware as e, useNuxtApp as f, asyncDataDefaults as g, createError as h, useState as i, useRuntimeConfig as j, nuxtLinkDefaults as k, navigateTo as n, resolveRouteObject as r, useHead as u };
